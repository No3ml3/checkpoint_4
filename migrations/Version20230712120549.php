 ...
 */
final class Version20230712120549 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE music ADD user_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD CONSTRAINT FK_8D93D649399BBB13 FOREIGN KEY (music_id) REFERENCES music (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
